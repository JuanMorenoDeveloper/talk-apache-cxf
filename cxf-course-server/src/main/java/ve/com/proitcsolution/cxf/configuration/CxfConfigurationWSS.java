...
public class CxfConfigurationWSS {
    ...
    public CallbackHandler clientKeystorePasswordCallback() {
        ...
        return callbacks -> {
            for (var callback : callbacks) {
                if (callback instanceof WSPasswordCallback passCallback && passwords.containsKey(passCallback.getIdentifier())) {
    ...
    public Map<String, Object> signingProperties(final Properties signProp, final Properties verSignProp) {
        var properties = new HashMap<String, Object>();
        ...
        properties.put(ConfigurationConstants.SIGNATURE_PARTS, "{Element}{" + WSSConstants.NS_SOAP11 + "}" + WSS4JConstants.ELEM_BODY);
        /*properties.put(ConfigurationConstants.SIG_ALGO,
                "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256");*/
        return properties;
    }

    public Map<String, Object> encryptionProperties(final Properties encProp, final Properties decProp) {
        ...
        properties.put(ConfigurationConstants.ENCRYPTION_PARTS, "{Content}{" + WSSConstants.NS_SOAP11 + "}" + WSS4JConstants.ELEM_BODY);
